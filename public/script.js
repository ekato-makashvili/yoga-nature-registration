(function () {
  ...
  function updateBreathLabel() {
    ...
    breathLabel.textContent =
      breathLabel.dataset.phase === "exhale"
        ? dict.breathExhale
        : dict.breathInhale;
  }
  ...
  setInterval(() => {
    breathLabel.dataset.phase =
      breathLabel.dataset.phase === "inhale" ? "exhale" : "inhale";
    updateBreathLabel();
  }, 4000);
  ...
  document
    .querySelectorAll(".package-card input[type=radio]")
    .forEach((input) => {
